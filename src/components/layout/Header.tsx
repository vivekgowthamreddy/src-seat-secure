    ...
    >
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-4 group">
          <div className={`w-11 h-11 rounded-full overflow-hidden ring-2 transition-all ${
            isLanding 
          ...
          <div className="flex flex-col">
            <span className={`font-display font-semibold text-xl leading-tight tracking-tight ${
