                  ...
                  {typeof currentBooking.showId === 'object' && (
                    <>
                      ...
                      <div className="flex items-center gap-2 mt-2 w-full">
                        ...
                        <span className="font-mono text-white font-bold bg-white/10 px-2 py-1 rounded border border-white/5 shadow-sm">SRC-{currentBooking.id.slice(-6).toUpperCase()}</span>
                      </div>
                    </>
                  )}
                </div>
